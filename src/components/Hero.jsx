...
import profilepic from "../assets/pro1 (1).jpg";
import { AiFillLinkedin, AiFillGithub, AiFillInstagram } from "react-icons/ai";
import { TypeAnimation } from "react-type-animation";
import cv from "../assets/ahmed.pdf"
import {
  DiJavascript1,
  DiReact,
  DiNodejsSmall,
    ...
    <div className="max-w-[1200px] mx-auto grid md:grid-cols-8 gap-6 p-10 md:p-0 md:py-40" id="home">
      ...
      <div className="my-auto ml-8  flex-col">
        ...
        <TypeAnimation
          ...
          <p className="text-xl md:text-3xl font-bold text-gray-500 mb-5">
